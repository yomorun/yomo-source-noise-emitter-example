...
var (
	brokerAddr = getString("YOMO_SOURCE_MQTT_BROKER_ADDR", "tcp://localhost:1883")
	topic      = getString("YOMO_SOURCE_MQTT_PUB_TOPIC", "NOISE")
	interval   = getInt("YOMO_SOURCE_MQTT_PUB_INTERVAL", 500)
	counter    int64
)
